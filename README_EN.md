...
<p align="center">
  <img alt="Release" src="https://img.shields.io/badge/release-2.5.2-111111">
...
Codex Pulse supports the Responses API and can locally convert Chat Completions providers such as DeepSeek to the protocol required by Codex. GPT‑5.6 third-party routes automatically apply a Responses Lite compatibility override. The built-in connection test validates the Base URL, API key, model, and protocol before a provider is enabled.
...
Download [`Codex-Pulse-2.5.2.dmg`](dist/Codex-Pulse-2.5.2.dmg), open it, and drag `Codex Pulse.app` into `Applications`.
...
The app is generated at `build/Codex Pulse.app`, and the installer is generated at `dist/Codex-Pulse-2.5.2.dmg`.
