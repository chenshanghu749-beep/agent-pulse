...
Agent Pulse is a native macOS menu bar routing and status tool for Codex and Cursor. It provides Agent selection, Codex provider routing, usage monitoring, and task status without modifying those apps.
